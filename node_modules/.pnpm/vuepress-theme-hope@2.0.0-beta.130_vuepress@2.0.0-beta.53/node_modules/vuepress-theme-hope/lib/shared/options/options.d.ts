...
export interface ThemeOptions extends AppearanceOptions, FeatureOptions, InfoOptions, LayoutOptions, ThemeData<ThemeLocaleOptions> {
    plugins?: PluginsOptions;
}
export interface ThemeConfig extends AppearanceConfig, FeatureConfig, InfoOptions, LayoutConfig {
